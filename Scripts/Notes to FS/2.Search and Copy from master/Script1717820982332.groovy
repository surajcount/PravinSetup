...
WebUI.setText(findTestObject('Notes_Firm/SearchInMaster'), 'Basis')

WebUI.click(findTestObject('Notes_Firm/SearchedNote'))

WebUI.click(findTestObject('Notes_Firm/span_add Firm templates'))

WebUI.click(findTestObject('Notes_Firm/div_Select Folder'))

WebUI.click(findTestObject('Object Repository/Notes_Firm/span_PSP_Katalon'))
