...
WebUI.callTestCase(findTestCase('Notes to FS/7.Manual_Column_Format'), [:], FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.click(findTestObject('Notes_Firm/Manual_Column_Data/3 Columns'))
